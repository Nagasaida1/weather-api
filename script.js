...
const apiKey = '552691ca158bfcb4fb79fe06125fad74'; // Replace with your actual API key
...
async function updateWeatherInfo(city) {
    ...
    tempTxt.textContent = Math.round(temp - 273.15) + ' °C'; // Convert Kelvin to Celsius
...
function updateForecastItems(weatherData) {
    ...
    const forecastItem = `
        <div class="forecast-item">
            ...
            <h5 class="forecast-item-temp">${Math.round(temp - 273.15)} °C</h5> <!-- Convert to Celsius -->
        </div>
    `;
